...
/// It supports **union** and **find** operations, along with methods for determining whether two nodes are in the same component and the total number of components.
...
public struct UF {
    ...
    /// Returns root of the node given.
